...
export const MODEL_PROVIDERS: ModelProvider[] = [
  ...
  { id: "deepseek", label: "DeepSeek", baseUrl: "https://api.deepseek.com/v1", models: [{ id: "deepseek-v4-flash", label: "DeepSeek V4 Flash（默认）", inputCostPerMillion: 0.28, outputCostPerMillion: 0.42 }, { id: "deepseek-chat", label: "DeepSeek Chat（最新非推理）", inputCostPerMillion: 0.28, outputCostPerMillion: 0.42 }, { id: "deepseek-reasoner", label: "DeepSeek Reasoner（最新推理）", inputCostPerMillion: 0.55, outputCostPerMillion: 2.19 }] },
